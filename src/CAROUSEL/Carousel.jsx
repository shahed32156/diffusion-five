...
const Carousel = () => {
  return (
    ...
    <>
      ...
      <section style={{backgroundImage:'url("./Images/spider-net.png")', backgroundPosition:""}} className=' pt-28 lg:pt-8 xl:pt-24 xl:pb-8 bg-opacity-5 px-3 lg:px-10 xl:px-20 2xl:px-36'>

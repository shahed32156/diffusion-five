...
const Navbar = () => {
    ...
    return (
        <nav className="bg-[#0a0a28dd] fixed w-full z-10 top-0 left-0">
            <div className="mx-auto px-3 md:px-8 lg:px-12 xl:px-16">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="act-links hidden lg:flex items-center gap-8 text-xl">
                        ...
                        <NavLink to="/blog" className="text-white text-sm font-medium relative hover:text-blue-500 duration-500 before:content-[''] before:absolute before:left-0 before:-bottom-2 before:h-[3px] before:w-full before:bg-white before:scale-x-0 before:origin-left before:transition-transform before:duration-500 hover:before:scale-x-100">Blog</NavLink>
                        ...
                        <Link to="/appoinment" className="text-white text-sm font-medium rounded-sm duration-500 bg-blue-600 hover:bg-blue-500 h-[45px] w-[110px] flex justify-center items-center">Appoinment</Link>
            ...
            {/* Mobile Menu */}
            <div className={`lg:hidden fixed top-0 left-0 w-2/3 bg-[#0a0a28dd] h-full z-20 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out`}>
                <div className="act-links flex flex-col space-y-4 p-4">
                        ...
                        <NavLink to="/blog" className="text-white text-sm font-medium relative hover:text-blue-500 duration-500 before:content-[''] before:absolute before:left-0 before:-bottom-2 before:h-[3px] before:w-[80px] before:bg-white before:scale-x-0 before:origin-left before:transition-transform before:duration-500 hover:before:scale-x-100" onClick={closeMenu}>Blog</NavLink>
                        <NavLink to="/contact_us" className="text-white text-sm font-medium relative hover:text-blue-500 duration-500 before:content-[''] before:absolute before:left-0 before:-bottom-2 before:h-[3px] before:w-[80px] before:bg-white before:scale-x-0 before:origin-left before:transition-transform before:duration-500 hover:before:scale-x-100" onClick={closeMenu}>Contact</NavLink>
                        <Link to="/appoinment" className="text-white text-sm font-medium rounded-sm duration-500 bg-blue-600 hover:bg-blue-500 h-[45px] w-[110px] flex justify-center items-center" onClick={closeMenu}>Appoinment</Link>
                </div>
            </div>
            {/* Overlay */}

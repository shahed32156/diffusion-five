...
const About = () => {
  return (
    ...
    <section className='text-white mt-20'>
            ...
            <div className='flex flex-col lg:flex-row items-center gap-5 lg:gap-20 justify-center mx-3 '> 
                        ...
                        <div className='flex flex-col gap-4'>
                               ...
                               <NavLink to="/technology_stack" className='mt-3 mx-auto lg:mx-0 bg-gradient-to-r hover:bg-gradient-to-l duration-500 hover:scale-105 to-blue-500 from-pink-500 h-[45px] w-[150px] rounded-lg flex justify-center items-center'>
                                 Discover More
                                </NavLink>
                        </div>
            </div>

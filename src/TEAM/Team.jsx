    ...
    <>
      <div className='text-white mt-20 text-center flex flex-col items-center gap-3 mx-3'>
        <h1 className='text-3xl sm:text-4xl font-bold'>
          Leadership <span className='text-gradient'>Profile</span>
      ...
      <section className='mt-10 text-white grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mx-3 md:mx-10 lg:mx-[38px] xl:mx-48 2xl:mx-72'>
        {teamMembers.map((member, index) => (
          <div
            key={index}
            className='border-2 py-4 border-gray-600 bg-[#4b4b4b] bg-opacity-40 shadow-2xl hover:shadow-blue-300 hover:border-blue-300 duration-500 w-[300px] sm:w-full rounded-2xl mx-auto'
          >

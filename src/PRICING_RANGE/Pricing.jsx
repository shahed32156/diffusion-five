...
const PricingCard = ({ title, description, price, features, note }) => {
  return (
    <div className='flex flex-col gap-3 shadow-2xl hover:shadow-blue-300 duration-500 border-2 w-full mx-auto py-4 px-4 hover:border-blue-300 border-gray-600 rounded-xl'>
...
const Pricing = () => {
  ...
  return (
    <>
      ...
      <section className='text-white mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-8 mx-3 xl:mx-10 2xl:mx-32'>
